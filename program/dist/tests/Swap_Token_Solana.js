...
function createAssociatedTokenAccountInstr(owner, user, token) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/ , (0, spl_token_1.getAssociatedTokenAddress)(token.publicKey, user.publicKey)];
                case 1:
...
function mintInstruction(owner, token, lamports) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/ , (0, spl_token_1.getAssociatedTokenAddress)(token.publicKey, owner.publicKey)];
                case 1:
